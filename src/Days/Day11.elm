module Days.Day11 exposing (getPuzzleAnswer, getPuzzleAnswer2)
...
type alias HexCoordinates =
    ( Int, Int, Int )


updateHexCoordinates : HexCoordinates -> Maybe Direction -> HexCoordinates
updateHexCoordinates hexCoords direction =
    case direction of
        Just North ->
            ( Triplet.first hexCoords
            , Triplet.second hexCoords + 1
            , Triplet.third hexCoords - 1
            )
        ...
        Just NorthWest ->
            ( Triplet.first hexCoords - 1
            , Triplet.second hexCoords + 1
            , Triplet.third hexCoords
            )

        Just NorthEast ->
            ( Triplet.first hexCoords + 1
            , Triplet.second hexCoords
            , Triplet.third hexCoords - 1
            )
